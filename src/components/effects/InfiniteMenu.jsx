      ...
      cardsRef.current.forEach((card, index) => {
        ...
        const tl = gsap.timeline({
          scrollTrigger: {
            ...
            start: "top 90%",        // يبدأ الحركة أبكر (كان 80%)
            end: "center 45%",       // ينتهي أبكر (كان bottom top)
            scrub: 0.5,              // أسرع (كان 2) - كلما قل الرقم زادت السرعة
            // scrub: true,          // أو استخدم true لأسرع استجابة ممكنة
          }
        });
