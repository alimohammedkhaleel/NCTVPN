...
const pillarsData = [
  {
    ...
    desc: 'We implement a Zero-Trust Network Architecture (ZTNA). Every packet traversing the public WAN between campuses is subjected to rigorous encapsulation and military-grade encryption using AES-256 combined with SHA-3 for data integrity. The VPN tunnels utilize advanced IPsec with IKEv2 to guarantee dynamic key rotation and immunity to MITM attacks.'
  },
  {
    id: '02',
    title: 'High-Availability & Self-Healing Routing',
    desc: 'The network backbone is designed with multiple layers of redundancy. Utilizing intelligent enterprise routers with active-active paths and automatic 4G/LTE failover, the infrastructure achieves 99.99% uptime. If a primary fiber circuit suffers a rupture, edge routers shift critical payloads within milliseconds, preventing session drops.'
  },
  {
    id: '03',
    title: 'Integrated Voice & Collaboration Grid',
    desc: 'Telephony and collaborative communications are completely overhauled across the state. By bridging enterprise-grade IP-PBX telephony switching systems over the secure, encrypted local VPN tunnels, we have created an autonomous, private, nationwide voice grid.'
  },
  {
    id: '04',
    title: 'Advanced Traffic Prioritization & Distribution',
    desc: 'To maintain continuous performance during high-concurrency events—such as synchronized national electronic examinations—the switching matrix utilizes advanced Quality of Service (QoS) and Class of Service (CoS) profiles.'
  }
];

export default function FundamentalPillars({ 
  title = "Fundamental Pillars of the", 
  highlightText = "National VPN Grid", 
