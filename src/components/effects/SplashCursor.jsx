  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas) {
      try {
        ...
        // If no WebGL context available, return null
        if (!gl) {
    ...
    function generateColor() {
      // Yellow Hue is around 0.12 - 0.16
      let hue = 0.12 + Math.random() * 0.05;
    ...
    return () => {
      ...
      window.removeEventListener('scroll', preventCursor);
      window.removeEventListener('wheel', preventCursor);
    };
